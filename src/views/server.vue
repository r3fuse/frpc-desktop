            ...
            <div class="config">
                ...
                <div class="portAndMethod">
                    <div class="port item">
                        ...
                        <input type="number" id="port" max="65536" min="0" v-model="config.serverPort" />
                    </div>
